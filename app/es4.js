...
app.get('/', function (req, res) {
  res.render('es4', {message: 'impariamo la geografia', title:'fila B'});
});

app.get('/info', function (req, res) {
  var nazione = req.query.nazione;
  var lingue = req.query.lingua;
  // mi serve un vettore per inserire le traduzioni
  var result = [];
  // ciclo su ogni traduzione richiesta
  ...
  // restituisco il vettore result che contiene le traduzioni
